...
import { baseWorlds, WorldSection } from './worlds'
import './App.css'
...
export function PerkLink({ perk }: { perk: Perk }) {
  return (
    <ShallowPerkLink pid={perk.id} ptitle={perk.title} />
  );
}
export function ShallowPerkLink({ pid, ptitle }: { pid: string, ptitle: string }) {
  return (
...
export function PerkListing({ perk }: { perk: Perk }) {
  return (
    <div id={perk.id}>
...
function App() {
  ...
  const basePerkOutpostBuilding: Perk = {
  ...
  const basePerkBridgeFinding: Perk = {
  ...
  const basePerkBridgeBuilding: Perk = {
  ...
  const basePerkSoftContact: Perk = {
  ...
  const basePerkHiddenBridges: Perk = {
  ...
  const basePerkGatewayInvestiture: Perk = {
  ...
  const basePerkWarlocksFealty: Perk = {
  ...
  const basePerkInductionBasis: Perk = {
  ...
  const basePerkInductionInvestiture: Perk = {
  ...
  const basePerkGenesisSeed: Perk = {
  ...
  const drawbackCorrosiveContact: Perk = {
  ...
  const drawbackDisorganization: Perk = {
  ...
  const drawbackLivingBridge: Perk = {
  ...
  const earthlessInheritance: Perk = {
